  ...
  return (
    <>
      ...
      <div className="min-h-screen p-4 sm:p-6 flex flex-col items-center bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 font-[family-name:var(--font-geist-sans)] overflow-x-hidden">
        ...
        <header className="w-full md:max-w-4xl text-center mt-6 mb-4 sm:mt-8 sm:mb-10 relative overflow-hidden">
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="relative mb-6 ">
                <div className="relative">
                 <img src="https://linglan008-blog.oss-cn-hangzhou.aliyuncs.com/WechatIMG15507.jpeg" className='rounded-xl w-20 h-20' alt="" />
                </div>
              </div>
              ...
              <div className="relative flex flex-col items-center space-y-3">
                ...
                <div className="relative">
                  <h1 className="relative text-4xl sm:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 via-blue-500 to-cyan-400 tracking-wider drop-shadow-2xl transform hover:scale-105">
                     小易拼豆
                  </h1>
